...
const idsValidator = body('order_ids').notEmpty().withMessage(errorWithMessage(errorCode.ParameterError)).isArray().withMessage(errorWithMessage(errorCode.ParameterError))
const idValidator = body('order_id').notEmpty().withMessage(errorWithMessage(errorCode.ParameterError)).isArray().withMessage(errorWithMessage(errorCode.ParameterError))
...
router.post('/serve', idsValidator, controllers.serve)
router.post('/pend', idValidator, controllers.pend)
router.post('/unpend', idValidator, controllers.unpend)
